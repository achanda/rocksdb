...
const std::vector<std::pair<Histograms, std::string>> HistogramsNameMap = {
    ...
    {DB_GET_RET1_CORE_JOULES, "rocksdb.db.get.ret1.core.joules"},
    {DB_GET_RET2_CORE_JOULES, "rocksdb.db.get.ret2.core.joules"},
    {DB_GET_RET3_CORE_JOULES, "rocksdb.db.get.ret3.core.joules"},
