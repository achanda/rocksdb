...
const std::vector<std::pair<Histograms, std::string>> HistogramsNameMap = {
    ...
    {DB_GET_PACKAGE_JOULES, "rocksdb.db.get.package.joules"},
    {DB_GET_FILTER_PACKAGE_JOULES, "rocksdb.db.get.filter.package.joules"},
    {DB_GET_INDEX_PACKAGE_JOULES, "rocksdb.db.get.index.package.joules"},
    {DB_GET_DISK_PACKAGE_JOULES, "rocksdb.db.get.disk.package.joules"},
    {DB_GET_DRAM_JOULES, "rocksdb.db.get.dram.joules"},
    {DB_GET_FILTER_DRAM_JOULES, "rocksdb.db.get.filter.dram.joules"},
    {DB_GET_INDEX_DRAM_JOULES, "rocksdb.db.get.index.dram.joules"},
    {DB_GET_DISK_DRAM_JOULES, "rocksdb.db.get.disk.dram.joules"},
